<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <div class="grid grid-cols-6 mt-1 gap-2">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">{{ __('You may choose to include your middle initial, but it is not required.') }}</p>
