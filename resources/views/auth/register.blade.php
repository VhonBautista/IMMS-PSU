        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-4">
            ...
            <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}">
                ...
                <div class="flex items-start pt-3 ms-1" style="margin-top: 12px !important;">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="terms" class="font-light text-gray-500 dark:text-gray-300">{{ __('I accept the') }} <a class="font-medium text-blue-600 hover:underline dark:text-blue-500" href="{{ asset('assets/terms/Terms-and-Conditions-for-PSUIMMS.docx') }}">{{ __('Terms and Conditions') }}</a></label>
                    </div>
                </div>
