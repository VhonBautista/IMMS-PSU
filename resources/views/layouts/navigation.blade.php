                ...
                <div class="hidden sm:-my-px sm:ms-10 sm:flex">
                    <div class="text-sm font-medium text-center text-gray-500">
                        <ul class="flex flex-wrap -mb-px">
                            <li class="me-1">
                                <a href="{{ route('home') }}" class="inline-block p-5 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" aria-current="page">Home</a>
                            </li>
                            <li class="me-1">
